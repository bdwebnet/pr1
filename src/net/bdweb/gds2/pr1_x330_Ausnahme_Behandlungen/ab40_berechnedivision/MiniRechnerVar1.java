package net.bdweb.gds2.pr1_x330_Ausnahme_Behandlungen.ab40_berechnedivision;
...
public class MiniRechnerVar1 {
    ...
    public static void berechneDivision () {
        ...
        try {
            ...
            System.out.println("Sie hätten bei der Eingabe besser aufpassen sollen");
